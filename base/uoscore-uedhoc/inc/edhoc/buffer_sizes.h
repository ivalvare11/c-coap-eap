...
#ifndef ID_CRED_PSK_SIZE
#define ID_CRED_PSK_SIZE 400
#endif

#ifndef CRED_PSK_SIZE
#define CRED_PSK_SIZE 400
#endif

#ifndef K_CRED_PSK_SIZE
#define K_CRED_PSK_SIZE 400
#endif
...
#define PLAINTEXT2_PSK_SIZE                                                        \
	(AS_BSTR_SIZE(C_R_SIZE) + EAD_SIZE)
#define CIPHERTEXT2_PSK_SIZE PLAINTEXT2_PSK_SIZE
#define G_Y_CIPHERTEXT_2_PSK (G_Y_SIZE + CIPHERTEXT2_PSK_SIZE)
...
#define PLAINTEXT3B_PSK_SIZE EAD_SIZE

#define CIPHERTEXT3B_PSK_SIZE PLAINTEXT3B_PSK_SIZE + MAC_SIZE

#define PLAINTEXT3A_PSK_SIZE AS_BSTR_SIZE(ID_CRED_PSK_SIZE) + AS_BSTR_SIZE(CIPHERTEXT3B_PSK_SIZE)

#define CIPHERTEXT3A_PSK_SIZE PLAINTEXT3A_PSK_SIZE

#define CTXT_3A_CTXT_3B_PSK (CIPHERTEXT3A_PSK_SIZE + CIPHERTEXT3B_PSK_SIZE)
...
#define TH3_PSK_INPUT_SIZE                                                        \
	(AS_BSTR_SIZE(HASH_SIZE) + PLAINTEXT23_MAX_SIZE)

#define TH4_PSK_INPUT_SIZE                                                        \
	(AS_BSTR_SIZE(HASH_SIZE) + ID_CRED_PSK_SIZE + CRED_I_SIZE + CRED_R_SIZE + PLAINTEXT3B_PSK_SIZE)
