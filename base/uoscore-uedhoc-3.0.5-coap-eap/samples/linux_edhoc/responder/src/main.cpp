...
#define ORIG
	...
	//set_resp_creds_file("../../../test_vectors/psks_r.txt");
	...
	while (1) {
		...
		*/
		...
		TRY(ephemeral_dh_key_gen(alg, seed, &Y_random, &G_Y_random));
		...
		//store_creds(&rKID, &CRED_I_out, &CRED_R_out, "../../../test_vectors/psks_r.txt");
