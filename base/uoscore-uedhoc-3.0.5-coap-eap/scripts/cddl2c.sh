...
# decode CWT with COSE_Key (new)
python3 $ZCBOR code -c $MODELS_PATH/cwt_cred.cddl -d -t CWT --oc $SRC/cwt_decode.c --include-prefix $INC_PATH_IN_C_FILES --oh $INC/cwt_decode.h

# encode CWT with COSE_Key (new)
python3 $ZCBOR code -c $MODELS_PATH/cwt_cred.cddl -e -t CWT --oc $SRC/cwt_encode.c --include-prefix $INC_PATH_IN_C_FILES --oh $INC/cwt_encode.h
...
# plaintext
python3 $ZCBOR code -c $MODELS_PATH/edhoc_plaintext.cddl -d -t ptxt2 --oc $SRC/edhoc_decode_plaintext2.c --include-prefix $INC_PATH_IN_C_FILES --oh $INC/edhoc_decode_plaintext2.h

python3 $ZCBOR code -c $MODELS_PATH/edhoc_plaintext.cddl -d -t ptxt3 --oc $SRC/edhoc_decode_plaintext3.c --include-prefix $INC_PATH_IN_C_FILES --oh $INC/edhoc_decode_plaintext3.h

python3 $ZCBOR code -c $MODELS_PATH/edhoc_plaintext.cddl -d -t ptxt2_psk --oc $SRC/edhoc_psk_decode_plaintext2.c --include-prefix $INC_PATH_IN_C_FILES --oh $INC/edhoc_psk_decode_plaintext2.h

python3 $ZCBOR code -c $MODELS_PATH/edhoc_plaintext.cddl -d -t ptxt3a_psk --oc $SRC/edhoc_psk_decode_plaintext3a.c --include-prefix $INC_PATH_IN_C_FILES --oh $INC/edhoc_psk_decode_plaintext3a.h

python3 $ZCBOR code -c $MODELS_PATH/edhoc_plaintext.cddl -d -t ptxt3b_psk --oc $SRC/edhoc_psk_decode_plaintext3b.c --include-prefix $INC_PATH_IN_C_FILES --oh $INC/edhoc_psk_decode_plaintext3b.h
