...
#define PLAINTEXT2_PSK_SIZE (AS_BSTR_SIZE(C_R_SIZE) + EAD_SIZE)
...
#define PLAINTEXT3A_PSK_SIZE                                                   \
	AS_BSTR_SIZE(ID_CRED_PSK_SIZE) + AS_BSTR_SIZE(CIPHERTEXT3B_PSK_SIZE)
...
#define TH3_PSK_INPUT_SIZE (AS_BSTR_SIZE(HASH_SIZE) + PLAINTEXT23_MAX_SIZE)

#define TH4_PSK_INPUT_SIZE                                                     \
	(AS_BSTR_SIZE(HASH_SIZE) + ID_CRED_PSK_SIZE + CRED_I_SIZE +            \
	 CRED_R_SIZE + PLAINTEXT3B_PSK_SIZE)
